	...
	return (
		...
		>
			<Section
				...
				whileInView="show"
			>
				<Heading tag="h2" size="sm" className="px-0">
				...
				<button
					...
					className="rounded-xl border py-2 border-gray-600/90 hover:bg-gray-100/5"
				>
					<Typography
						size="md"
						className="text-white tracking-wider flex-place-center gap-2"
					>
						<Dot className="bg-white size-2  rounded-full" />
						Send Message
					</Typography>
				</button>
			</Section>
