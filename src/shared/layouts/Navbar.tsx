			...
			{active && (
				<Backdrop className="lg:hidden top-18">
					<FramerAnimatePosition
						className={cn(
							className,
							"fixed w-screen max-w-6/10 h-screen right-0 flex justify-end text-center rounded-l-2xl overflow-hidden backdrop-blur-md mx-auto ",
						)}
						{...props}
					...
					>
						<div
							ref={captureRef(1)}
							className="h-[calc(100dvh-4.5rem)] px-4 py-5 w-full bg-muted max-w-sm border-l grid grid-rows-[1fr_auto] border-muted-secondary"
						>
